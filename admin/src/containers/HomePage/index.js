          ...
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>
                ...
                publishers para essa maravilhosa loja de jogos!
              </P>
              <h3>Jrcaldas - Admin</h3>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>
                Em caso de dúvidas ou sugestões é só acessar alguns de nossos
                links =).
              </P>
              <div id="HomePage.roadmap">
                {
                  <ALink
